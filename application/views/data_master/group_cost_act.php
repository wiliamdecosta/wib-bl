...
<?php $this->load->view('lov/lov_activity'); ?>
...
function showLOVDepreciation(id, code) {
    modal_lov_activity_show(id, code);
}
...
<script>
    ...
    jQuery(function($) {
        ...
        jQuery("#grid-table").jqGrid({
            url: '<?php echo WS_JQGRID."data_master.group_cost_act_controller/crud"; ?>',
            datatype: "json",
            mtype: "POST",
            colModel: [
                {label: 'ID', name: 'groupcostactid_pk', key: true, width: 100, sorttype: 'number', editable: true, hidden: true},
                ...
                {label: 'Activity', name: 'activitycode', width: 200,  editable: false, search:false, sortable:false},
                {label: 'Activity',
                    name: 'activityid_fk',
                    width: 200,
                    sortable: true,
                        ...
                        "custom_element":function( value  , options) {
                            ...
                            setTimeout( function() {
                                elm.append('<input id="form_activityid_fk" type="text"  style="display:none;">'+
                                        ...
                                        '<button class="btn btn-success" type="button" onclick="showLOVDepreciation(\'form_activityid_fk\',\'form_activitycode\')">'+
                                        '   <span class="fa fa-search bigger-110"></span>'+
                                        '</button>');
            ...
            editurl: '<?php echo WS_JQGRID."data_master.group_cost_act_controller/crud"; ?>',
            caption: "GL Category"
