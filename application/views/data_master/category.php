...
<script>
    ...
    jQuery(function($) {
        ...
        jQuery("#grid-table").jqGrid({
            url: '<?php echo WS_JQGRID."data_master.category_controller/crud"; ?>',
            datatype: "json",
            mtype: "POST",
            colModel: [
                {label: 'ID', name: 'categoryid_pk', key: true, width: 5, sorttype: 'number', editable: true, hidden: true},
            ...
            editurl: '<?php echo WS_JQGRID."data_master.category_controller/crud"; ?>',
            caption: "Category"
