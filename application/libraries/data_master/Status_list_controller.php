...
/**
* Json library
* @class Status_list_controller
* @version 2018-05-30 10:11:50
*/
class Status_list_controller {
    ...
    function read() {
        ...
        $sidx = getVarClean('sidx','str','statuslistid_pk');
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('data_master/status_list');
            $table = $ci->status_list;
