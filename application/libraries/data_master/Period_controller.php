...
class Period_controller {
    ...
    function read() {
        ...
        $sidx = getVarClean('sidx','str','periodid_pk');
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('data_master/period');
            $table = $ci->period;
            ...
            $data['success'] = true;
            logging('view data master period');
        }catch (Exception $e) {
    ...
    function create() {
        ...
        if (isset($items[0])){
            ...
            try{
                ...
                $data['success'] = true;
                $data['message'] = 'Data added successfully';
                logging('create data master period');
    ...
    function update() {
        ...
        if (isset($items[0])){
            ...
            try{
                ...
                $data['success'] = true;
                $data['message'] = 'Data update successfully';
                logging('update data master period');
    ...
    function destroy() {
        ...
        try{
            ...
            logging('delete data master period');
            $table->db->trans_commit(); //Commit Trans
