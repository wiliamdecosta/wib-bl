...
class Category_controller {
    ...
    function read() {
        ...
        $sidx = getVarClean('sidx','str','categoryid_pk');
        ...
        try {
            ...
            $data['success'] = true;
            logging('view data master category');
        }catch (Exception $e) {
    ...
    function create() {
        ...
        if (isset($items[0])){
            ...
            try{
                ...
                $data['success'] = true;
                $data['message'] = 'Data added successfully';
                logging('create data master category');
    ...
    function update() {
        ...
        if (isset($items[0])){
            ...
            try{
                ...
                $data['success'] = true;
                $data['message'] = 'Data update successfully';
                logging('update data master category');
    ...
    function destroy() {
        ...
        try{
            ...
            logging('delete data master category');
            $table->db->trans_commit(); //Commit Trans
