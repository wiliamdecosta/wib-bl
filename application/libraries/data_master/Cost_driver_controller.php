...
class Cost_driver_controller {
    ...
    function read() {
        ...
        $sidx = getVarClean('sidx','str','costdriverid_pk');
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('data_master/cost_driver');
            $table = $ci->cost_driver;
            ...
            $data['success'] = true;
            logging('view data master cost driver');
        }catch (Exception $e) {
    ...
    function create() {
        ...
        if (isset($items[0])){
            ...
            try{
                ...
                $data['success'] = true;
                $data['message'] = 'Data added successfully';
                logging('create data master cost driver');
    ...
    function update() {
        ...
        if (isset($items[0])){
            ...
            try{
                ...
                $data['success'] = true;
                $data['message'] = 'Data update successfully';
                logging('update data master cost driver');
    ...
    function destroy() {
        ...
        try{
            ...
            logging('delete data master cost driver');
            $table->db->trans_commit(); //Commit Trans
...
/* End of file Cost_driver_controller.php */