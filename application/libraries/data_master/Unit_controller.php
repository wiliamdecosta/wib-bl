...
class Unit_controller {
    ...
    function read() {
        ...
        $sidx = getVarClean('sidx','str','unitid_pk');
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('data_master/unit');
            $table = $ci->unit;
    ...
    function create() {
        ...
        if (isset($items[0])){
            ...
            try{
                ...
                $data['success'] = true;
                $data['message'] = 'Data added successfully';
                logging('create data master unit');
    ...
    function update() {
        ...
        if (isset($items[0])){
            ...
            try{
                ...
                $data['success'] = true;
                $data['message'] = 'Data update successfully';
                logging('update data master unit');
    ...
    function destroy() {
        ...
        try{
            ...
            logging('delete data master unit');
            $table->db->trans_commit(); //Commit Trans
...
/* End of file Unit_controller.php */