 ...
 *
 */
class Amortization extends Abstract_model {

    public $table           = "tblm_amortization_1";
    public $pkey            = "amortization_pk";
    public $alias           = "amortization";

    public $fields          = array(
                                'amortizationid_pk'      => array('pkey' => true, 'type' => 'int', 'nullable' => true, 'unique' => true, 'display' => 'AmortizationID_PK'),
    ...
    public $selectClause    = "amortization.*";
    public $fromClause      = "tblm_amortization_1 amortization";
